...
/* eslint-disable */
/**
 * The active time of api key (ActiveTime will required when ApiKeyType is 1)
 */
export type qilinApiKeyActiveTime = {
    /**
     ...
     * 1: Month
     */
    apiKeyActiveTimeType?: qilinApiKeyActiveTime.apiKeyActiveTimeType;
    /**
...
export namespace qilinApiKeyActiveTime {
    /**
     * The type of active time.<br/>
     * Value:<br/>
     * 0: Week<br/>
