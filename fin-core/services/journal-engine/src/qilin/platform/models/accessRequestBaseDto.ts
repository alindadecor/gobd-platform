...
export type accessRequestBaseDto = {
    /**
     ...
     * 3: Closed
     */
    status?: accessRequestBaseDto.status | null;
    /**
     ...
     * 2: Otherwise
     */
    supportType?: accessRequestBaseDto.supportType;
    /**
...
export namespace accessRequestBaseDto {
    /**
     * The status of the access request<br/>
     * Value:<br/>
     * 0: Requested<br/>
