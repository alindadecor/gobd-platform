...
export type ticketLifecycleDetailDto = {
    /**
     * The time when this change of state occurred.
     */
    changedDate?: string;
    /**
     * The status name after the change (= the new status).
     */
    newStateName?: string;
    /**
     * The status value before the change.<br/>
     ...
     * 15: OtherClosed
     */
    oldState?: ticketLifecycleDetailDto.oldState;
    /**
     ...
     * 15: OtherClosed
     */
    newState?: ticketLifecycleDetailDto.newState;
    changedBy: messageSender;
};
export namespace ticketLifecycleDetailDto {
    /**
     * The status value before the change.<br/>
     * The data type of the status<br/>
     * Value:<br/>
